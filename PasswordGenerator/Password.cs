...
/// <summary>
    ...
    public class Password : IPassword
    {
        ...
        private static RandomNumberGenerator _rngNew;
        ...
        public Password()
        {
            ...
            _rngNew = RandomNumberGenerator.Create();
        }
        ...
        public string Next()
        {
            ...
            {
                password =
                    $"La lunghezza della password non è valida. Deve essere compresa tra {Settings.MinimumLength} e {Settings.MaximumLength} caratteri.";
            }
            else
            {
                ...
                password = PasswordIsValid(Settings, password) ? password : "Cortesemente, riprovare. Grazie.";
            }
